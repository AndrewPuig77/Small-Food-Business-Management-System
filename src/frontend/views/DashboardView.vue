  ...
  <div class="dashboard">
    ...
    <div class="top-bar">
      <div class="business-info">
        <h1 class="text-2xl font-bold text-white">{{ businessName }}</h1>
    ...
    <div class="main-content">
      ...
      <main class="content">
        <div class="content-header">
          ...
          <p class="text-gray-300">Here's what's happening with your business today.</p>
        </div>

        <!-- Stats Grid -->
        <div class="stats-grid">
          <div class="stat-card">
            <div class="stat-icon bg-blue-900/50">
          ...
          <div class="stat-card">
            <div class="stat-icon bg-green-900/50">
              <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="stat-card">
            <div class="stat-icon bg-purple-900/50">
              <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />
              </svg>
            </div>
          ...
          <div class="stat-card">
            <div class="stat-icon bg-orange-900/50">
              <svg fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
              </svg>
            </div>
        ...
        <div class="quick-actions">
          ...
          <div class="actions-grid">
            <button class="action-btn" @click="showComingSoon('New Order')">
              <svg class="action-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6v6m0 0v6m0-6h6m-6 0H6" />
              </svg>
              <span>New Order</span>
            </button>
            <button class="action-btn" @click="goToEmployees">
              <svg class="action-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <button class="action-btn" @click="showScheduleManager">
              <svg class="action-icon" fill="none" stroke="currentColor" viewBox="0 0 24 24">
